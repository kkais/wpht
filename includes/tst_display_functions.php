    ...
    $tst_shortcode = 
		shortcode_atts(
			array(
				...
				'tst_color' => '',
				'tst_size' => '',
				'tst_all' => '0',  // Added by Khurram
				'tst_interval' => '5',  // Added by Khurram
				'txt_align' => '',
				'subtitle_color' => '',
				'subtitle_size' => '0.8em',
				'subtitle_italic' => '',
...
function hndtst_shortcode_single_css( $tst_shortcode, $tstiditr ) {
	...
	*****************************************/
    ...
    $tst_all = $tst_shortcode['tst_all']; // Added by Khurram    
    $tst_interval = $tst_shortcode['tst_interval']; // Added by Khurram
